...
export declare const makeVAvatarGroupProps: <Defaults extends {
    ...
    limit: unknown extends Defaults["limit"] ? NumberConstructor : {
        type: PropType<unknown extends Defaults["limit"] ? number : number | Defaults["limit"]>;
        default: unknown extends Defaults["limit"] ? number : number | Defaults["limit"];
    };
